	...
	methods: {
      ...
      function addDemoGraphic11(graphicLayer) {
        const graphic = new mars3d.graphic.BillboardEntity({
          ...
          style: {
        // ![组 4235@2x _1_.png](https://s2.loli.net/2024/01/05/vs6rdKbNatG5ZXB.png)
        // ![组 4350@2x.png](https://s2.loli.net/2024/01/05/FezRPluoXEa3n1v.png)
            // 支持base64
            image:
                "https://s2.loli.net/2024/01/05/vs6rdKbNatG5ZXB.png",
            scale: 0.5,
